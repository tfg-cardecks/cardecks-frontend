...
export default function SelectDeckGameHangman() {
        ...
        switch (response.status) {
          case 201:
            Swal.fire({
              ...
              navigate(`/hangmanGame/${response.data.hangmanGameId}`);
            });
            break;
          case 200:
            if (response.data.message === "Ya tienes un Juego del Ahorcado en progreso") {
              setInProgressGameId(response.data.hangmanGameId);
            }
            break;
          case 400:
          case 401:
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-4 text-center">Selecciona un Mazo para {gameInfo.title}</h1>
